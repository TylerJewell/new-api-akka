...
A `LICENSE-new-api` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [QuantumNous/new-api](https://github.com/QuantumNous/new-api), Copyright
the QuantumNous/new-api authors, licensed under AGPL-3.0. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../new-api-port/specs/SPEC-001-new-api.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
